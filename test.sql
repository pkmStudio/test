...
insert into `groups`(`id`, `id_parent`, `name`)
values (1, 0, 'Электроника'),
       (2, 0, 'Одежда'),
       (3, 0, 'Бытовая техника'),
...
insert into `prices`(`id`, `id_product`, `price`)
values (101, 1, 52490.00),
       (102, 2, 5755.00),
       (103, 3, 16480.00),
       (104, 4, 96990.00),
       (105, 5, 1896.00),
...
insert into `products`(`id`, `id_group`, `name`)
values (1, 11, 'Смартфон Apple iPhone 12 mini 128 ГБ'),
